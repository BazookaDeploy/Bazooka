...
namespace Web.CommandHandlers
{
    public class ModifyDatabaseTaskHandler : CommandHandler<ModifyDatabaseTask>
    {
        public override void Apply(ModifyDatabaseTask command)
        {
            ...
            application.ModifyDatabaseTask(command.DatabaseTaskId, command.Name, command.ConnectionString, command.Package, command.DatabaseName, command.Repository, command.AgentId);
