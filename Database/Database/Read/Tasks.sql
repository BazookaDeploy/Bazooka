CREATE VIEW [rd].[Tasks]
	AS ( 
		...
		UNION
		SELECT Id,Name,2 AS Type, EnviromentId,ApplicationId, Position FROM [dbo].LocalScriptTasks WHERE Deleted  = 0 
		UNION
		SELECT Id,Name,3 AS Type, EnviromentId,ApplicationId, Position FROM [dbo].RemoteScriptTasks WHERE Deleted  = 0 
		UNION
