...
CREATE VIEW [rd].[Deployers]
	...
	FROM (
		SELECT	Enviroments.Id as EnviromentId, Applications.Id as ApplicationId, AllowedUsers.UserID as UserId
			...
			WHERE Applications.Id = AllowedUsers.ApplicationId AND Enviroments.Id = AllowedUsers.EnviromentId AND Applications.Deleted = 0
		...
		SELECT	Enviroments.Id as EnviromentId, Applications.Id as ApplicationId, AspNetUserRoles.UserId
			...
			WHERE Applications.Id = AllowedGroups.ApplicationId AND Enviroments.Id = AllowedGroups.EnviromentId AND Applications.Deleted = 0 AND AllowedGroups.GroupId = AspNetUserRoles.RoleId
	) AS T